...
@interface PlayerDetailsTrackButtonsView ()
...
@implementation PlayerDetailsTrackButtonsView
...
- (void)setTitleArray:(NSArray *)titleArray {
    ...
    for (int i = 0; i < titleArray.count; i++) {
        ...
        if (self.isHorizontal) {
            buttonFrame = CGRectMake(0, 0, 50, 40);
        }
...
- (UIColor *)buttonColorIsSelected:(BOOL)isSelected {
    return isSelected ? [UIColor mainColor] : [UIColor whiteColor];
}
