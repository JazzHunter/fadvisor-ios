...
@interface PlayerDetailsDotView ()
...
@implementation PlayerDetailsDotView
...
- (void)seekToDot {
    if (self.delegate && [self.delegate respondsToSelector:@selector(dotViewClickToseek:)]) {
        [self.delegate dotViewClickToseek:_dotTime];
    }
}
