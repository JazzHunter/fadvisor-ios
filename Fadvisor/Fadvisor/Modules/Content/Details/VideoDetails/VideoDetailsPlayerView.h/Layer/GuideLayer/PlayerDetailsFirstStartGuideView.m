...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.centerImageView.image = [UIImage imageNamed:@"player_guide_center"];
        self.leftImageView.image = [UIImage imageNamed:@"player_guide_left"];
        self.rightImageView.image = [UIImage imageNamed:@"player_guide_right"];
...
- (void)layoutSubviews {
    ...
    self.centerImageView.frame = CGRectMake(0, 0, FirstStartGuideViewCenterIVWidth, FirstStartGuideViewCenterIVHeight);
    self.centerImageView.center = self.center;

    self.centerLabel.textAlignment = NSTextAlignmentCenter;
    self.centerLabel.center = self.centerImageView.center;
    self.centerLabel.frame = CGRectMake(0, 0, FirstStartGuideViewLabelWidth, FirstStartGuideViewLabelHeight);
    self.centerLabel.center = self.centerImageView.center;
    CGRect frame = self.centerLabel.frame;
    frame.origin.y = self.centerImageView.frame.origin.y + self.centerImageView.frame.size.height + FirstStartGuideViewMargin;
...
//    @"中心\n  进度调节";
    ...
    [maString addAttributes:@{ NSForegroundColorAttributeName: [UIColor whiteColor],
                               NSFontAttributeName: [UIFont systemFontOfSize:FirstStartGuideViewTextFont],
    ...
    self.leftImageView.frame = CGRectMake(self.centerImageView.frame.origin.x - FirstStartGuideViewImageViewMargin - FirstStartGuideViewLeftIVWidth, (height - FirstStartGuideViewLeftIVHeight) / 2, FirstStartGuideViewLeftIVWidth, FirstStartGuideViewLeftIVHeight);

    self.leftLabel.textAlignment = NSTextAlignmentCenter;
    self.leftLabel.frame = CGRectMake(0, 0, FirstStartGuideViewLabelWidth, FirstStartGuideViewLabelHeight);
    self.leftLabel.center = self.leftImageView.center;
    CGRect frame1 = self.leftLabel.frame;
    frame1.origin.y = self.centerImageView.frame.origin.y + self.centerImageView.frame.size.height + FirstStartGuideViewMargin;
...
//    @"左侧\n  亮度调节";
    ...
    self.rightImageView.frame = CGRectMake(self.centerImageView.frame.origin.x + self.centerImageView.frame.size.width + FirstStartGuideViewImageViewMargin, (height - FirstStartGuideViewLeftIVHeight) / 2, FirstStartGuideViewLeftIVWidth, FirstStartGuideViewLeftIVHeight);

    self.rightLabel.textAlignment = NSTextAlignmentCenter;
    self.rightLabel.frame = CGRectMake(0, 0, FirstStartGuideViewLabelWidth, FirstStartGuideViewLabelHeight);
    self.rightLabel.center = self.rightImageView.center;
    CGRect frame3 = self.rightLabel.frame;
    frame3.origin.y = self.centerImageView.frame.origin.y + self.centerImageView.frame.size.height + FirstStartGuideViewMargin;
