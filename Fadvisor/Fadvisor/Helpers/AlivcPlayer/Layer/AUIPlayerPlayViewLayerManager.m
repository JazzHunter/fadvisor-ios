...
@property (nonatomic, strong) NoActionView *lowView;
@property (nonatomic, strong) NoActionView *middleView;
@property (nonatomic, strong) NoActionView *heightView;
