...
//        _lockButton.accessibilityIdentifier = [self accessibilityId:@"lockButton"];
        ...
        [_lockButton setImage:[UIImage imageNamed:@"player_unlock"] forState:UIControlStateNormal];
        [_lockButton setImage:[UIImage imageNamed:@"player_lock"] forState:UIControlStateSelected];
