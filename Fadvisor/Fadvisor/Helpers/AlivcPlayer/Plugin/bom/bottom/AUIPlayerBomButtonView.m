...
@property (nonatomic, strong) CustomImageButton *halfScreenButton;
...
- (CustomImageButton *)halfScreenButton
{
    if (!_halfScreenButton) {
        _halfScreenButton = [[CustomImageButton alloc] initWithFrame:CGRectMake(12, 0, self.height, self.height)];
//        _halfScreenButton.accessibilityIdentifier = AUIVideoFlowAccessibilityStr(@"bomButton_halfScreenButton");
        _halfScreenButton.imageSize = CGSizeMake(14, 14);

        [_halfScreenButton setImage:[UIImage imageNamed:@"player_halfscreen" ] forState:UIControlStateNormal];
