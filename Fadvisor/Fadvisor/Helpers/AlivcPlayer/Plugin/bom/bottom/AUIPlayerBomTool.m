...
//        _progressView.accessibilityIdentifier = AUIVideoFlowAccessibilityStr(@"bomTool_progressView");
        _progressView.frame = CGRectMake(0, 0, self.buttonView.left, 42);
...
//        _buttonView.accessibilityIdentifier = AUIVideoFlowAccessibilityStr(@"bomTool_buttonView");
        _buttonView.frame = CGRectMake(0, self.progressView.bottom, self.width,  self.height - self.progressView.bottom);
...
- (AUIPlayerBomPortraitButtons *)portraitButtonView
{
    if (!_portraitButtonView) {
        _portraitButtonView = [[AUIPlayerBomPortraitButtons alloc] initWithFrame:CGRectMake(self.width - 30, 0, 30, 42)];
...
- (void)layoutSubviews
{
    ...
    _portraitButtonView.frame = CGRectMake(self.width - pButonWidth, 0, pButonWidth, 42);
    if (self.fullScreen) {
        _progressView.frame = CGRectMake(24, 0, self.portraitButtonView.left - 24 *2, 42);

    } else {
        _progressView.frame = CGRectMake(0, 0, self.portraitButtonView.left, 42);
    ...
    _watchPointContainer.frame = CGRectMake(0, 0, self.progressView.progressView.width, 20);
