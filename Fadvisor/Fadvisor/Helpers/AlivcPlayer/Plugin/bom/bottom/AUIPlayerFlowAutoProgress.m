...
//        //设置它的风格，为默认的
//        _loadtimeView.trackTintColor= AlivcPlayerColor(@"vf_progress_track");
//        //设置轨道的颜色
//        _loadtimeView.progressTintColor= AlivcPlayerColor(@"vf_progress");
//    }
...
//        _timeView.accessibilityIdentifier = AUIVideoFlowAccessibilityStr(@"bomFlowAutoProgress_timeView");
        ...
        //设置它的风格，为默认的
        _timeView.trackTintColor= AlivcPlayerColor(@"vf_progress_track");
        //设置轨道的颜色
        _timeView.progressTintColor= AlivcPlayerColor(@"vf_slider");
    }
    return _timeView;
}
...
- (void)layoutSubviews{
    ...
    //self.loadtimeView.frame = CGRectMake(AUIPlayerFlowAutoProgressViewLoadtimeViewLeft, 0, self.width - AUIPlayerFlowAutoProgressViewLoadtimeViewLeft * 2, self.height);
    self.timeView.frame = CGRectMake(AUIPlayerFlowAutoProgressViewLoadtimeViewLeft, 0, self.width - AUIPlayerFlowAutoProgressViewLoadtimeViewLeft * 2, self.height);
