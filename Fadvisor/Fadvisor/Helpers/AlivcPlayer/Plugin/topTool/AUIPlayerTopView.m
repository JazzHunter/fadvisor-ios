...
- (void)layoutSubviews
{
    ...
    _statusBar.frame = CGRectMake(0, 0, self.width, self.landScape?24:0);
    _topActionView.frame = CGRectMake(0, _statusBar.bottom + (self.landScape?0:8), self.width, kButtonSizeWidth);
