...
//    netLabel.accessibilityIdentifier = AUIVideoFlowAccessibilityStr(@"netLabel");
    ...
    netLabel.font = [UIFont systemFontOfSize:12 weight:UIFontWeightRegular];
...
//    batteryLabel.accessibilityIdentifier = AUIVideoFlowAccessibilityStr(@"batteryLabel");
    ...
    batteryLabel.font = [UIFont systemFontOfSize:12 weight:UIFontWeightRegular];
...
+ (NSString *)getNetType{
    ...
    NetworkReachability *reach = [NetworkReachability reachabilityWithHostName:@"www.apple.com"];
